...
% --- Executes on key press with focus on datasetTable and none of its controls.
...
% --- Executes on button press in yogyakarta.
function yogyakarta_Callback(hObject, eventdata, handles)
% hObject    handle to yogyakarta (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of yogyakarta
...
% --- Executes on button press in semarang.
function semarang_Callback(hObject, eventdata, handles)
% hObject    handle to semarang (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of semarang
checkBoxListener(hObject , handles);

% --- Executes on button press in bandung.
function bandung_Callback(hObject, eventdata, handles)
% hObject    handle to bandung (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bandung
checkBoxListener(hObject , handles);

% --- Executes on button press in jakarta.
function jakarta_Callback(hObject, eventdata, handles)
% hObject    handle to jakarta (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of jakarta
checkBoxListener(hObject , handles);
% --- Executes on button press in surabaya.
function surabaya_Callback(hObject, eventdata, handles)
% hObject    handle to surabaya (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of surabaya
checkBoxListener(hObject , handles);
...
result = main(categoryValue, cityPicked, weightCriteria);
